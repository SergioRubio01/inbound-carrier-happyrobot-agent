...
class TestUpdateLoadEndpoint:
    ...
    async def test_successful_load_update(self, client: AsyncClient, sample_load_in_db, api_key_headers):
    ...
    async def test_update_with_location_changes(self, client: AsyncClient, sample_load_in_db, api_key_headers):
    ...
    async def test_update_with_schedule_changes(self, client: AsyncClient, sample_load_in_db, api_key_headers):
    ...
    async def test_valid_status_transition(self, client: AsyncClient, sample_load_in_db, api_key_headers):
        """Test valid status transition."""
        # Arrange
        load_id = str(sample_load_in_db.load_id)
        update_data = {
            "version": 1,
            "status": "BOOKED"  # AVAILABLE -> BOOKED is valid
        }
    ...
    async def test_version_conflict(self, client: AsyncClient, sample_load_in_db, api_key_headers):
    ...
    async def test_invalid_status_transition(self, client: AsyncClient, sample_load_in_db, api_key_headers):
    ...
    async def test_cannot_update_delivered_load(self, client: AsyncClient, sample_load_in_db, api_key_headers):
    ...
    async def test_validation_errors(self, client: AsyncClient, sample_load_in_db, api_key_headers):
    ...
    async def test_missing_version_field(self, client: AsyncClient, sample_load_in_db, api_key_headers):
        """Test missing version field."""
        # Arrange
        load_id = str(sample_load_in_db.load_id)
        update_data = {
            "weight": 30000  # Missing version
        }
    ...
    async def test_invalid_equipment_type(self, client: AsyncClient, sample_load_in_db, api_key_headers):
    ...
    async def test_invalid_date_logic(self, client: AsyncClient, sample_load_in_db, api_key_headers):
    ...
    async def test_partial_update_preserves_existing_values(self, client: AsyncClient, sample_load_in_db, api_key_headers):
    ...
    async def test_update_with_all_fields(self, client: AsyncClient, sample_load_in_db, api_key_headers):
