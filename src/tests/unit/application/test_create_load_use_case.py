...
class MockLoadRepository(ILoadRepository):
    ...
    async def get_by_reference_number(self, reference_number: str) -> Load:
...
def valid_create_request():
    ...
    return CreateLoadRequest(
        ...
        delivery_datetime=delivery_date.replace(hour=16, minute=0, second=0, microsecond=0),
...
class TestCreateLoadUseCase:
    ...
    @pytest.mark.asyncio
    async def test_create_load_success(self, create_load_use_case, valid_create_request):
    ...
    @pytest.mark.asyncio
    async def test_create_load_with_custom_reference(self, create_load_use_case, valid_create_request):
    ...
    @pytest.mark.asyncio
    async def test_create_load_duplicate_reference_fails(self, create_load_use_case, valid_create_request, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_create_load_missing_origin_fails(self, create_load_use_case, valid_create_request):
    ...
    @pytest.mark.asyncio
    async def test_create_load_missing_destination_fails(self, create_load_use_case, valid_create_request):
    ...
    @pytest.mark.asyncio
    async def test_create_load_invalid_rate_fails(self, create_load_use_case, valid_create_request):
    ...
    @pytest.mark.asyncio
    async def test_create_load_invalid_weight_fails(self, create_load_use_case, valid_create_request):
    ...
    @pytest.mark.asyncio
    async def test_create_load_invalid_dates_fails(self, create_load_use_case, valid_create_request):
    ...
    @pytest.mark.asyncio
    async def test_create_load_past_pickup_fails(self, create_load_use_case, valid_create_request):
    ...
    @pytest.mark.asyncio
    async def test_create_load_invalid_equipment_type_fails(self, create_load_use_case, valid_create_request):
