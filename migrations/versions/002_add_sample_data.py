...
def upgrade():
    ...
    carriers_table = sa.table('carriers',
...
def downgrade():
    # Delete sample data
    op.execute("DELETE FROM loads WHERE reference_number IN ('LOAD001', 'LOAD002', 'LOAD003')")
